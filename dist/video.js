(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactVideo"] = factory();
	else
		root["ReactVideo"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashThrottle = __webpack_require__(157);
	...
	var Video = (function (_React$Component) {
	  ...
	  _createClass(Video, [{
	    ...
	    key: 'onMuteUnmute',
	    value: function onMuteUnmute() {
	      var _this = this;

	      this.setState({ muted: !this.state.muted }, function () {
	        _this.state.player.muted = _this.state.muted;
	      });
	    }
	  }, {
	    key: 'onTimeUpdate',
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'video-media-container' },
	          _react2['default'].createElement(
	            'video',
	            { src: this.props.src, ref: 'player', width: this.state.width },
...
/***/ function(module, exports) {
	...
	exports['default'] = toVideoDuration;
	var floor = Math.floor;

	function toVideoDuration(timestamp) {
	  var group = [];
	  var hours = floor(timestamp / 3600);
	  var minutes = floor(timestamp % 3600 / 60);
	  var seconds = floor(timestamp % 3600 % 60);
